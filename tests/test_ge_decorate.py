...
def test_ge_decorations_canonical_pivots_and_variable_types():
    import importlib
    ...
    decor = ge_mod.ge_decorations(tr, index_base=1)
...
def test_ge_decorations_returns_canonical_render_specs_only():
    import importlib
    ge_mod = importlib.import_module("LAFigureSpecs.ge")
...
def test_ge_decorations_excludes_rhs_from_variable_types():
    import importlib
    ge_mod = importlib.import_module("LAFigureSpecs.ge")
...
def test_ge_decorations_signature_uses_rowechelon_path_grid_naming():
    import importlib
    ge_mod = importlib.import_module("LAFigureSpecs.ge")

    params = inspect.signature(ge_mod.ge_decorations).parameters
