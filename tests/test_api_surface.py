...
def test_compatibility_aliases_point_to_canonical_helpers():
    import LAFigureSpecs

    assert LAFigureSpecs.eig_tbl_svg is LAFigureSpecs.eig_svg
    assert LAFigureSpecs.svd_tbl_svg is LAFigureSpecs.svd_svg
    assert LAFigureSpecs.ge_tbl_spec is LAFigureSpecs.ge_spec
    assert LAFigureSpecs.qr_tbl_spec is LAFigureSpecs.qr_spec
    assert LAFigureSpecs.eig_tbl_spec is LAFigureSpecs.eig_spec
    assert LAFigureSpecs.svd_tbl_spec is LAFigureSpecs.svd_spec
    assert LAFigureSpecs.ge_tbl_tex is LAFigureSpecs.ge_tex
    assert LAFigureSpecs.qr_tbl_tex is LAFigureSpecs.qr_tex
    assert LAFigureSpecs.eig_tbl_tex is LAFigureSpecs.eig_tex
    assert LAFigureSpecs.svd_tbl_tex is LAFigureSpecs.svd_tex
    assert LAFigureSpecs.ge_tbl_bundle is LAFigureSpecs.ge_bundle
    assert LAFigureSpecs.qr_tbl_bundle is LAFigureSpecs.qr_bundle
    assert LAFigureSpecs.eig_tbl_bundle is LAFigureSpecs.eig_bundle
    assert LAFigureSpecs.svd_tbl_bundle is LAFigureSpecs.svd_bundle
