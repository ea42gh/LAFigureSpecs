...
def test_qr_svg_passes_render_opts(monkeypatch):
    recorded: Dict[str, Any] = {}
...
def test_ge_svg_passes_render_opts(monkeypatch):
    recorded: Dict[str, Any] = {}
...
def test_ge_svg_defaults_to_tight_crop(monkeypatch):
    recorded: Dict[str, Any] = {}
