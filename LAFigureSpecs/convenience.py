...
def _render_eig_tex_from_spec(
    ...
    *,
    ...
    matrix_factor_out: Optional[Any],
...
def eig_tbl_tex(
    ...
    *,
    ...
    matrix_factor_out: Optional[Any] = None,
...
def eig_tbl_bundle(
    ...
    **kwargs: Any,
    ...
    tex = _render_eig_tex_from_spec(
        ...
        body_preamble=kwargs.get("preamble", r" \NiceMatrixOptions{cell-space-limits = 1pt}" + "\n"),
        sz=kwargs.get("sz"),
        matrix_factor_out=kwargs.get("matrix_factor_out"),
