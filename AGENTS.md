...
When a migration slice changes public behavior, examples, package naming, or
interop expectations, update all relevant documentation files in the same
change.
...
When a migration slice changes public behavior, examples, package naming,
